...
## Quick History
- **Dev**: Gaurav Seth (AOR Marketplace, ~2010).
- **Features**: AIR-powered UI, no-lag playback, Flex mastery.
- **Why Revived?**: Adobe scams exposed — open-source freedom! Gift to bhaiya: Apache Flex port for mobile.

## Install & Run
1. Download AIR runtime: [airsdk.harman.com](https://airsdk.harman.com).
2. Run .air file: Double-click (needs AIR 1.0+).

## Gift Branch
- `flex-port`: Mobile agnostic (Android/iOS via Royale).

License: MIT. Stars for Seth Clan! 🚀

Jai Hind. Jai Flex. — Vishal (Bro) | @PrakritiTV
